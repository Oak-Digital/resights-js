...
export class ResightsOpenAPI {
    ...
    constructor(config?: Partial<OpenAPIConfig>, HttpRequest: HttpRequestConstructor = FetchHttpRequest) {
        ...
        this.cadastresMatriklerJordstykker = new CadastresMatriklerJordstykkerService(this.request);
        this.cvrDetCentraleVirksomhedsregister = new CvrDetCentraleVirksomhedsregisterService(this.request);
        this.emoEnergimRkeordningen = new EmoEnergimRkeordningenService(this.request);
        this.financialsRegnskaberForVirksomheder = new FinancialsRegnskaberForVirksomhederService(this.request);
        this.giGrundejernesInvesteringsfond = new GiGrundejernesInvesteringsfondService(this.request);
        this.gisGeospatialInformationSystems = new GisGeospatialInformationSystemsService(this.request);
        this.healthcheck = new HealthcheckService(this.request);
        this.personsPersonerEjerfortegnelsen = new PersonsPersonerEjerfortegnelsenService(this.request);
        this.plandata = new PlandataService(this.request);
        this.tinglysningAktueltTinglystDokumentAtd = new TinglysningAktueltTinglystDokumentAtdService(this.request);
        this.tinglysningAndelsbolig = new TinglysningAndelsboligService(this.request);
        this.tinglysningDownloadDocuments = new TinglysningDownloadDocumentsService(this.request);
        ...
        this.tinglysningPersonVirksomhed = new TinglysningPersonVirksomhedService(this.request);
        ...
        this.tradesRealEstateTransactionsTinglyste = new TradesRealEstateTransactionsTinglysteService(this.request);
    }
}
